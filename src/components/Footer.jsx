...
export default function Footer() {
  return (
    <footer className="bg-zinc-950 text-white py-16 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h2 className="text-3xl font-serif tracking-wide mb-6">
          Ramrati Eye Hospital
        </h2>
        <p className="text-gray-400 mb-10 max-w-md mx-auto font-light leading-relaxed">
          Redefining Ophthalmology excellence with personalized care and advanced natural treatments.
        </p>
        ...
        <div className="text-gray-500 text-sm font-light border-t border-white/5 pt-8">
          &copy; {new Date().getFullYear()} Ramrati Eye Hospital. All rights reserved. <br/>
