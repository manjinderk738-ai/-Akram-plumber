...
const services = [
  {
    title: 'Consultation',
    description: 'Comprehensive evaluation and personalized Ophthalmology treatment plans.',
    icon: Activity,
  },
  {
    title: 'Chronic Diseases',
    description: 'Effective Ophthalmology treatment for chronic illnesses, focusing on root causes for long-term relief.',
    icon: ShieldCheck,
  },
  {
  ...
  },
  {
    ...
    description: 'Immunity boosting and general well-being treatments using natural Ophthalmology medicines.',
    icon: Activity,
  }
];
    ...
    <section id="services" className="py-24 relative overflow-hidden bg-transparent text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-serif mb-6 leading-tight">Specialized Ophthalmology Services</h2>
