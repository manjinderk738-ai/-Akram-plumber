...
export default function Header() {
  const whatsappNumber = "919027489104"; // without the plus, required format for WhatsApp API
          ...
          <div className="flex justify-between items-center h-24">
            <div className="flex-shrink-0 flex items-center">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] text-gold-500 font-semibold mt-1">Eye Hospital</span>
              </div>
            </div>
